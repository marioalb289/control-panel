<div class="row">
    ...
    <div class="col-md-8">
        ...
        <p class="lead">
            by <a href="index.php"><?php echo $publicacion['Autor']['nombre'] ?></a>
        </p>
        <p><span class="glyphicon glyphicon-time"></span> Posted on <?php echo $publicacion['Publicacion']['created'] ?></p>
        <hr>
